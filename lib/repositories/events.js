    ...
    AND: [
      ...
      query ? {
        OR: [
          ...
          { descricao: { contains: normalizeText(query), mode: 'insensitive' } },
          { localizacao: { contains: normalizeText(query), mode: 'insensitive' } },
          { ngo: { nome: { contains: normalizeText(query), mode: 'insensitive' } } },
